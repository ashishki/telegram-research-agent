...
Verification:
  - PYTHONPATH=src PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 python3 -m pytest -q tests/test_prm_product_ux_eval.py::test_product_ux_keeps_project_context_for_confirmation_followups tests/test_prm_post_answer_actions.py::test_post_answer_controls_require_private_owner_actor_binding tests/test_prm_post_answer_actions.py::test_post_answer_context_binds_canonical_snapshot_and_project_ref tests/test_prm_post_answer_actions.py::test_dynamic_post_answer_codes_require_issued_bound_transition tests/test_prm_bot_dispatch.py::test_prm_entrypoints_propagate_private_owner_identity_or_render_no_controls tests/test_prm_bot_dispatch.py::test_post_answer_callback_preserves_bound_source_without_reroute tests/test_prm_bot_dispatch.py::test_plain_language_action_selection_rejects_stale_or_cross_topic_context tests/test_callbacks.py::TestIdeaCallbacks::test_run_bot_prm_safe_routes_only_post_answer_callbacks tests/test_prm_utd_callbacks.py tests/test_prm_utd_dispatch.py
