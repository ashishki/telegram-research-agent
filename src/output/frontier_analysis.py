...
def _build_prompt(context: dict, *, lookback_weeks: int) -> str:
    ...
    return (
        ...
        "events; promote topics similar to read, tried, useful, or applied_to_project events; treat "
        "missed-post and priority-calibration feedback_eval_examples as eval examples for coverage and ranking. "
        "If feedback_context has no events, say personalization confidence is low.\n"
